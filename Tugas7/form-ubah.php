...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        //Ubah Data
        if(!empty($nim) and !empty($nama) and !empty($email) and !empty($alamat) and !empty($kelamin) and empty($nimErr) and empty($namaErr) and empty($emailErr) and empty($alamatErr))
        {
        $id_data = $_POST["id"];
